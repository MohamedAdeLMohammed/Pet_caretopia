...
function AccessoriesDetails() {
    ...
    useEffect(() => {
        const getAccessoriesProducts = async () => {
            try {
                ...
                console.error(error);
                Swal.fire("Error", "Failed to fetch accessories", "error");
            } finally {
                setLoading(false);
            }
        };
    ...
    if (loading) {
        return <div className="loading-message">Loading accessories...</div>;
    }
  ...
  <>
    ...
    <Link to="/home/store/MedicationsProductsDetails" className="store-link">Medications</Link>
            ...
            <div className="all-cats-container">
                <h2 className="management-dashboard-title">Carriers & Travel</h2>
