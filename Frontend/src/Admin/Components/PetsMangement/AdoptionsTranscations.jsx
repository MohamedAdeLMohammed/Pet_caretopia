...
function AdoptationTranscations() {
          ...
          <div className="table-responsive">
              <table className="table products-table">
                <thead>
                  ...
                  <tr>
                    <th scope="col"><FaPaw className="me-1" /> Pet</th>
                  ...
                  {requests.length > 0 ? (
                    requests.map((req) => (
                      <tr key={req.id} className="align-middle">
                        ...
                        <td>{new Date(req.adoptionDate).toLocaleDateString()}</td>
...
export default AdoptationTranscations;