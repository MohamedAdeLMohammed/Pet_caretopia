...
//                                        "/shelters/{shelterId}/adoptions",
//                                        "/shelters/{id}",
//                                        "/facilities/all",
//                                        "/facilities/serviceProvider/{serviceProviderId}",
//                                        "/facilities/type",
//                                        "/facilities/facilityName",
//                                        "/facilities/facilityWithSP/{facilityId}",
//                                        "/facilities/facility/{facilityId}",
//                                        "/feedbacks/serviceProvider/{id}",
//                                        "/feedbacks/user/{id}",
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authz -> authz
                        ...
                        .requestMatchers(HttpMethod.POST, "/shelters/**").authenticated()
                        .requestMatchers(HttpMethod.PUT, "/shelters/**").authenticated()
                        .requestMatchers(HttpMethod.DELETE, "/shelters/**").authenticated()
