...
@Repository
public interface FacilityNotificationRepository extends JpaRepository<FacilityNotification, Long> {
...
//
//    Collection<Object> findByRecipientUserID(Long recipientId);
}
